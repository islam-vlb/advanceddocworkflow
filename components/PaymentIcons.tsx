export default function PaymentIcons({ size = "h-8" }: { size?: string }) {
  return (
    <div className="flex items-center gap-3">
      <svg viewBox="0 0 50 32" className={`${size} w-auto rounded-lg opacity-90`} aria-label="Visa" xmlns="http://www.w3.org/2000/svg">
      ...
      <svg viewBox="0 0 50 32" className={`${size} w-auto rounded-lg opacity-90`} aria-label="Mastercard" xmlns="http://www.w3.org/2000/svg">
